...
async function main() {
  ...
  const { SystemSettingsModel } = await import('../../src/models/systemSettings.model');
  ...
  const { runMaintenanceReminderWorker } = await import('../../src/services/maintenanceReminderWorker.service');
  const { runThresholdAlertWorker } = await import('../../src/services/thresholdAlertWorker.service');

...
async function main() {
  ...
  const { ConsumableBalanceModel } = await import('../../src/modules/consumables/models/consumableBalance.model');
  ...
  const { ApprovalMatrixRequestModel } = await import('../../src/models/approvalMatrixRequest.model');

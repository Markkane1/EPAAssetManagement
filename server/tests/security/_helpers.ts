...
export interface SeededContext {
  ...
  models: {
    UserModel: typeof import('../../src/models/user.model').UserModel;
    OfficeModel: typeof import('../../src/models/office.model').OfficeModel;
    EmployeeModel: typeof import('../../src/models/employee.model').EmployeeModel;
    DocumentModel: typeof import('../../src/models/document.model').DocumentModel;
    VendorModel: typeof import('../../src/models/vendor.model').VendorModel;
    AssetModel: typeof import('../../src/models/asset.model').AssetModel;
    AssetItemModel: typeof import('../../src/models/assetItem.model').AssetItemModel;
    AssignmentModel: typeof import('../../src/models/assignment.model').AssignmentModel;
    MaintenanceRecordModel: typeof import('../../src/models/maintenanceRecord.model').MaintenanceRecordModel;
  };
  offices: {
    officeA: any;
    officeB: any;
...
export async function bootstrapSecurityApp() {
  ...
  const { VendorModel } = await import('../../src/models/vendor.model');

...
async function main() {
  ...
  const { RequisitionModel } = await import('../../../../server/src/models/requisition.model');
  const { RequisitionLineModel } = await import('../../../../server/src/models/requisitionLine.model');
  const { RecordModel } = await import('../../../../server/src/models/record.model');
  const { DocumentModel } = await import('../../../../server/src/models/document.model');
  const { DocumentLinkModel } = await import('../../../../server/src/models/documentLink.model');
  const { AuditLogModel } = await import('../../../../server/src/models/auditLog.model');

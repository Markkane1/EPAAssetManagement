...
const appPages = [
  ...
  { id: "transfers-batch", name: "Batch Transfer", category: "Transfers" },
  { id: "transfers-returns", name: "Returns", category: "Transfers" },
  { id: "asset-management-transferred-assets", name: "Transferred Assets", category: "Asset Management" },
  { id: "asset-management-consumable-transfers", name: "Consumable Transfers", category: "Asset Management" },
  { id: "asset-management-functional-status", name: "Functional Status", category: "Asset Management" },
  { id: "asset-management-consumption-log", name: "Consumption Log", category: "Asset Management" },
...
const initialRoles: UserRole[] = [
  ...
  },
  {
    ...
    permissions: {
      ...
      maintenance: [],
      transfers: ["view"],
      "transfers-batch": ["view", "create"],
      "transfers-returns": ["view"],
      "asset-management-transferred-assets": ["view", "edit"],
      "asset-management-consumable-transfers": ["view"],
      "asset-management-functional-status": ["view", "edit"],
      "asset-management-consumption-log": ["view"],
      employees: [],
      locations: [],
      categories: [],
      directorates: [],

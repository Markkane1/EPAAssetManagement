...
export const maintenanceService = {
  ...
  getByAssetItem: (assetItemId: string) => api.get<MaintenanceRecord[]>(`/maintenance/asset-item/${assetItemId}`),
  
  getScheduled: () => api.get<MaintenanceRecord[]>('/maintenance/scheduled'),

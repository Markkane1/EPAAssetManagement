...
export const API_CONFIG = {
  ...
  messages: {
    ...
    consumableSupplierCreated: 'Supplier created successfully',
    consumableSupplierUpdated: 'Supplier updated successfully',
    consumableSupplierDeleted: 'Supplier deleted successfully',
    consumableSupplierError: 'Failed to process supplier',
    ...
    consumableLocationCreated: 'Location created successfully',
    consumableLocationUpdated: 'Location updated successfully',
    consumableLocationDeleted: 'Location deleted successfully',
    consumableLocationError: 'Failed to process location',
  ...
  queryKeys: {
    ...
    consumableSuppliers: ['consumableSuppliers'] as const,
    consumableUnits: ['consumableUnits'] as const,
    consumableContainers: ['consumableContainers'] as const,
    consumableLocations: ['consumableLocations'] as const,
